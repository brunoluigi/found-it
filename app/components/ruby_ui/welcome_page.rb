      ...
      div(class: "container mx-auto px-4 py-8") do
        div(class: "max-w-4xl mx-auto") do
          Card do
            ...
            Paragraph(class: "text-lg mb-4") { "Your personal item tracking assistant is ready to help you keep track of all your belongings." }
            ...
            Grid(cols: 1, md_cols: 2, gap: 6, class: "mb-8") do
              Card do
                Heading(level: 3) { "Register New Item" }
                Paragraph(class: "mb-4") { "Add your valuable items to FoundIT to make them easier to recover if lost." }
